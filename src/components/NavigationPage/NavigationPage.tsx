    ...
    return (
        <>
            <Container style={{width: 100, display: 'flex', flexDirection: 'column', gap: 10}}>
                <Row>
                    <Button variant="info" test-id={'button-1'} onClick={() => navigate(link)}>Кнопка 1</Button>
                </Row>
                <Row>
                    <Button variant="info" test-id={'button-2'} onClick={() => navigate(link, true)}>Кнопка 2</Button>
                </Row>
                <Row>
